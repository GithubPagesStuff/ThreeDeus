...
/usr/local/bin/wget https://github.com/nedwill/soundhax/blob/master/soundhax-eur-n3ds.m4a
/usr/local/bin/wget https://github.com/nedwill/soundhax/blob/master/soundhax-eur-o3ds.m4a
